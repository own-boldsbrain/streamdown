...
const tooltipStyles = {
  tooltip: "absolute bg-background border max-w-xs p-2 rounded shadow-md text-sm z-50",
...
export const VizMathLatexInline = memo((props: Omit<VizMathLatexProps, "displayMode">) => (
...
export const VizMathLatexBlock = memo((props: Omit<VizMathLatexProps, "displayMode">) => (
