...
export const ConsumptionPatternsReport: FC<GenericAgentReportProps> = ({ data }) => (
  <div className="border rounded-md p-4 text-sm" data-component="ConsumptionPatternsReport">
